...
[["Slam","Souplesse","Slam","Schianto","Portazo","たたきつける","摔打"],0,0,20,80,75],
...
[["Wrap","Ligotage","Wickel","Avvolgibotta","Repetición","まきつく","紧束"],0,0,20,15,90],
...
[["Surf","Surf","Surfer","Surf","Surf","なみのり","冲浪"],10,1,15,95,100],
[["Ice Beam","Laser Glace","Eisstrahl","Geloraggio","Rayo Hielo","れいとうビーム","冰冻光束"],14,1,10,95,100],
[["Blizzard","Blizzard","Blizzard","Bora","Ventisca","ふぶき","暴风雪"],14,1,5,120,70],
...
[["Smog","Purédpois","Smog","Smog","Polución","スモッグ","浊雾"],3,1,20,20,70],
...
[["Glare","Intimidation","Giftblick","Bagliore","Deslumbrar","へびにらみ","大蛇瞪眼"],0,2,30,0,90],
[["Dream Eater","Dévorêve","Traumfresser","Mangiasogni","Come Sueños","ゆめくい","食梦"],13,1,15,100,100],
[["Poison Gas","Gaz Toxik","Giftwolke","Velenogas","Gas Venenoso","どくガス","毒瓦斯"],3,2,40,0,80],
...
[["Crabhammer","Pince-Masse","Krabbhammer","Martellata","Martillazo","クラブハンマー","蟹钳锤"],10,0,10,90,90],
...
[["Fury Cutter","Taillade","Zornklinge","Tagliofuria","Cortefuria","れんぞくぎり","连斩"],6,0,20,20,95],
...
[["Future Sight","Prescience","Seher","Divinazione","Premonición","みらいよち","预知未来"],13,1,10,100,100],
...
[["Covet","Implore","Bezirzer","Supplica","Antojo","ほしがる","渴望"],0,0,40,60,100],
...
[["Assurance","Assurance","Gewissheit","Garanzia","Buena Baza","ダメおし","恶意追击"],16,0,10,50,100],
...
[["Draco Meteor","Draco Météor","Draco Meteor","Dragobolide","Cometa Draco","りゅうせいぐん","流星群"],15,1,5,140,90],
...
[["Magma Storm","Vortex Magma","Lavasturm","Magmaclisma","Lluvia Ígnea","マグマストーム","熔岩风暴"],9,1,5,120,75],
...
[["Storm Throw","Yama Arashi","Bergsturm","Tempestretta","Llave Corsé","やまあらし","山岚摔"],1,0,10,40,100],
...
[["Synchronoise","Synchropeine","Synchrolärm","Sincrumore","Sincrorruido","シンクロノイズ","同步干擾"],13,1,15,70,100],
...
[["Low Sweep","Balayette","Fußtritt","Calciobasso","Puntapié","ローキック","下盘踢"],1,0,20,60,100],
...
[["Hex","Châtiment","Bürde","Sciagura","Infortunio","たたりめ","祸不单行"],7,1,10,50,100],
...
[["Incinerate","Calcination","Einäschern","Bruciatutto","Calcinación","やきつくす","烧尽"],9,1,15,30,100],
...
[["Water Pledge","Aire d&#39;Eau","Wassersäulen","Acquapatto","Voto Agua","みずのちかい","水之誓约"],10,1,10,50,100],
[["Fire Pledge","Aire de Feu","Feuersäulen","Fiammapatto","Voto Fuego","ほのおのちかい","火之誓約"],9,1,10,50,100],
[["Grass Pledge","Aire d&#39;Herbe","Pflanzensäulen","Erbapatto","Voto Planta","くさのちかい","草之誓约"],11,1,10,50,100],
[["Volt Switch","Change Éclair","Voltwechsel","Invertivolt","Voltiocambio","ボルトチェンジ","伏特替换"],12,1,20,70,100],
[["Struggle Bug","Survinsecte","Käfertrutz","Entomoblocco","Estoicismo","むしのていこう","虫之抵抗"],6,1,20,30,100],
[["Bulldoze","Piétisol","Dampfwalze","Battiterra","Terratemblor","じならし","重踏"],4,0,20,60,100],
[["Frost Breath","Souffle Glacé","Eisesodem","Alitogelido","Vaho Gélido","こおりのいぶき","冰息"],14,1,10,40,90],
...
[["Sacred Sword","Lame Sainte","Sanctoklinge","Spadasolenne","Espada Santa","せいなるつるぎ","圣剑"],1,0,20,90,100],
...
[["Hurricane","Vent Violent","Orkan","Tifone","Vendaval","ぼうふう","暴风"],2,1,10,120,70],
...
[["Techno Blast","Techno-Buster","Techblaster","Tecnobotto","Tecno Shock","テクノバスター","高科技光炮"],0,1,5,85,100],
