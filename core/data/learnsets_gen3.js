...
const LEARNSET_GAMES=[
	['Ruby','Rubis','Rubin','Rubino','Rubí',,'红宝石'],
	['Sapphire','Saphir','Saphir','Zaffiro','Zafiro',,'蓝宝石'],
	['Emerald','Émeraude','Smaragd','Smeraldo','Esmeralda',,'绿宝石']
];
const LEARNSET_REMAKES=[
	['Fire Red','Rouge Feu','Feuerrot','Rosso Fuoco','Rojo Fuego',,'火红'],
	['Leaf Green','Vert Feuille','Blattgrün','Verde Foglia','Verde Hoja',,'叶绿']
];
