...
[["Gust","Tornade","Windstoß","Raffica","Tornado","かぜおこし"],2,0,35,40,100],
...
[["Bite","Morsure","Biss","Morso","Mordisco","かみつく"],16,1,25,60,100],
...
[["Dig","Tunnel","Schaufler","Fossa","Excavar","あなをほる"],4,0,10,60,100],
...
[["Bide","Patience","Geduld","Pazienza","Venganza","がまん"],0,0,10,0,100],
...
[["Struggle","Lutte","Verzweifler","Scontro","Combate","わるあがき"],0,0,1,50,100],
...
[["Thief","Larcin","Raub","Furto","Ladrón","どろぼう"],16,1,10,40,100],
[["Spider Web","Toile","Spinnennetz","Ragnatela","Telaraña","クモのす"],6,2,10,0,0],
[["Mind Reader","Lire-Esprit","Willensleser","Leggimente","Telépata","こころのめ"],0,2,5,0,100],
[["Nightmare","Cauchemar","Nachtmahr","Incubo","Pesadilla","あくむ"],7,2,15,0,0],
[["Flame Wheel","Roue de Feu","Flammenrad","Ruotafuoco","Rueda Fuego","かえんぐるま"],9,1,25,60,100],
[["Snore","Ronflement","Schnarcher","Russare","Ronquido","いびき"],0,0,15,40,100],
[["Curse","Malédiction","Fluch","Maledizione","Maldición","のろい"],-1,2,10,0,0],
[["Flail","Fléau","Dreschflegel","Flagello","Azote","じたばた"],0,0,15,0,100],
[["Conversion 2","Adaptation 2","Umwandlung2","Conversione2","Conversión2","テクスチャー２"],0,2,30,0,0],
[["Aeroblast","Aéroblast","Luftstoß","Aerocolpo","Aerochorro","エアロブラスト"],2,0,5,100,95],
[["Cotton Spore","Spore Coton","Baumwollsaat","Cottonspora","Esporagodón","わたほうし"],11,2,40,0,85],
...
[["Scary Face","Grimace","Grimasse","Visotruce","Cara Susto","こわいかお"],0,2,10,0,90],
[["Feint Attack","Feinte","Finte","Finta","Finta","だましうち"],16,1,20,60,0],
...
[["Sludge Bomb","Bomb-Beurk","Matschbombe","Fangobomba","Bomba Lodo","ヘドロばくだん"],3,0,10,90,100],
[["Mud-Slap","Coud&#39;Boue","Lehmschelle","Fangosberla","Bofetón Lodo","どろかけ"],4,0,10,20,100],
[["Octazooka","Octazooka","Octazooka","Octazooka","Pulpocañón","オクタンほう"],10,1,10,65,85],
[["Spikes","Picots","Stachler","Punte","Púas","まきびし"],4,2,20,0,0],
[["Zap Cannon","Élecanon","Blitzkanone","Falcecannone","Electrocañón","でんじほう"],12,1,5,100,50],
[["Foresight","Clairvoyance","Gesichte","Preveggenza","Profecía","みやぶる"],0,2,40,0,100],
...
[["Bone Rush","Charge-Os","Knochenhatz","Ossoraffica","Ataque Óseo","ボーンラッシュ"],4,0,10,25,80],
[["Lock-On","Verrouillage","Zielschuss","Localizza","Fijar Blanco","ロックオン"],0,2,5,0,100],
[["Outrage","Colère","Wutanfall","Oltraggio","Enfado","げきりん"],15,1,15,90,100],
[["Sandstorm","Tempête de Sable","Sandsturm","Terrempesta","Tormenta Arena","すなあらし"],5,2,10,0,0],
[["Giga Drain","Giga-Sangsue","Gigasauger","Gigassorbimento","Gigadrenado","ギガドレイン"],11,1,5,60,100],
...
[["Spark","Étincelle","Funkensprung","Scintilla","Chispa","スパーク"],12,1,20,65,100],
[["Fury Cutter","Taillade","Zornklinge","Tagliofuria","Cortefuria","れんぞくぎり"],6,0,20,10,95],
[["Steel Wing","Aile d&#39;Acier","Stahlflügel","Alacciaio","Ala De Acero","はがねのつばさ"],8,0,25,70,90],
[["Mean Look","Regard Noir","Horrorblick","Malosguardo","Mal De Ojo","くろいまなざし"],0,2,5,0,100],
...
[["Pain Split","Balance","Leidteiler","Malcomune","Divide Dolor","いたみわけ"],0,2,20,0,100],
[["Sacred Fire","Feu Sacré","Läuterfeuer","Magifuoco","Fuego Sagrado","せいなるほのお"],9,1,5,100,95],
...
[["Pursuit","Poursuite","Verfolgung","Inseguimento","Persecución","おいうち"],16,1,20,40,100],
...
[["Crunch","Mâchouille","Knirscher","Sgranocchio","Triturar","かみくだく"],16,1,15,80,100],
...
[["Ancient Power","Pouvoir Antique","Antik-Kraft","Forzantica","Poder Pasado","げんしのちから"],5,0,5,60,100],
[["Shadow Ball","Ball&#39;Ombre","Spukball","Palla Ombra","Bola Sombra","シャドーボール"],7,0,15,80,100],
[["Future Sight","Prescience","Seher","Divinazione","Premonición","みらいよち"],13,1,15,80,90],
[["Rock Smash","Éclate-Roc","Zertrümmerer","Spaccaroccia","Golpe Roca","いわくだき"],1,0,15,20,100],
[["Whirlpool","Siphon","Whirlpool","Mulinello","Torbellino","うずしお"],10,1,15,15,70],
[["Beat Up","Baston","Prügler","Picchiaduro","Paliza","ふくろだたき"],16,1,10,10,100]
];
